...
function buildImage () {
    ...
    .then(tour => {
        ...
        sessionStorage.setItem('namereservation',tour[val].name);
        sessionStorage.setItem('pricereservation',tour[val].price);
    ...
    var total_price = parseInt(sessionStorage.getItem('pricereservation')); 
    var tour_id = sessionStorage.getItem('namereservation');
     


    var total = num_reservations * total_price;
